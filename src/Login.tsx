                ...
                if (response.data.user) {
                    ...
                    presenceChannel
                        .on('presence', {event: 'sync'}, () => {
                            console.log('Presence state updated:', presenceChannel.presenceState());
                        })
    ...
    return (
        <div className="p-4 max-w-md mx-auto">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col">
                ...
                <button
                    type="submit"
                    className={`py-2 px-4 bg-blue-500 text-white rounded-lg mb-2 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                    disabled={loading}
                >
